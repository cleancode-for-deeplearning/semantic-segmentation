...
from utils.scheduler.scheduler import *
from model.networks.architectures.models import *
...
class Segmentation_Network(nn.Module):
	...
	def initialize_optimizers(self, iter_num):
		...
		backbone_mode, lr_division = self.opt.backboneMode, self.opt.lrDivision
